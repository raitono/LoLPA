...
CREATE TABLE IF NOT EXISTS `participant_timeline_delta` (
  ...
  UNIQUE KEY `deltaTypeId_increment` (`gameId`,`participantId`,`deltaTypeId`,`increment`),
...
-- Dumping structure for unknown, should never appear riot.
CREATE DATABASE IF NOT EXISTS `riot` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
-- Dumping structure for unknown, should never appear sys.
CREATE DATABASE IF NOT EXISTS `sys` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
-- Dumping structure for unknown, should never appear performance_schema.
CREATE DATABASE IF NOT EXISTS `performance_schema` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
-- Dumping structure for unknown, should never appear mysql.
CREATE DATABASE IF NOT EXISTS `mysql` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
-- Dumping structure for unknown, should never appear information_schema.
CREATE DATABASE IF NOT EXISTS `information_schema` /*!40100 DEFAULT CHARACTER SET utf8 */;
